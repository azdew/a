...
PS1='\$ '
alias new='clear; toilet -f Speed 'GAN XS' | lolcat -a -p 1 -d 15 -s 100; date | lolcat -a -d 5 -s 40; echo ________________________________________________________________ | lolcat -a -d 75 -s 500'
...
clear
toilet -f Speed 'GAN XS' | lolcat -a -d 15 -s 50 -p 1
date | lolcat -d 5 -a
